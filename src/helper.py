...
# Commented out hardcoded path - model will be loaded via load_model function
...
def load_model(model_path):
    ...
    """
    # Use the provided model_path, or default to yoloooo.pt if model_path is a .pkl file
    if str(model_path).endswith('.pkl'):
        # If it's a pickle file, use the yoloooo.pt model instead
        model_dir = Path(model_path).parent
        model = YOLO(str(model_dir / 'yoloooo.pt'))
    else:
